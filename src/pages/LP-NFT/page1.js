        ...
        <div className="flex flex-col items-center gap-10 w-[1300px] relative">
          ...
          <div className="flex flex-col items-start gap-5 w-full flex-none relative self-stretch">
            <div className="flex items-center justify-between w-full flex-none relative self-stretch">
              <div className="relative w-[125.07px] h-[27.04px]"><img className="absolute w-[123px] h-[18px] top-[5px] left-[2px]" src="/assets/images/logos/clip-path-group.svg" /></div>
              <img className="relative w-[125.07px] h-[60px]" src="/assets/images/logos/logo-2.svg" />
              <div className="relative w-[125.07px] h-[60px]"><img className="relative w-[125.07px] h-[60px]" src="/assets/images/logos/page.svg" /></div>
              <div className="relative w-[125.07px] h-[60px]"><img className="absolute w-[106px] h-[23px] top-[19px] left-[9px]" src="/assets/images/logos/polkadot-new-dot-logo-horizontal-1.svg" /></div>
              <div className="relative w-[125.07px] h-[60px]">
                <div className="relative w-[103px] h-[35px] top-[13px] left-[11px]">
                  <img className="absolute w-[61px] h-[15px] top-[10px] left-[35px]" src="/assets/images/logos/group-2.svg" /> <img className="absolute w-[22px] h-[21px] top-[7px] left-[7px]" src="/assets/images/logos/vector.svg" />
                </div>
              </div>
              <img className="relative w-[125.07px] h-[60px]" src="/assets/images/logos/image.svg" />
            </div>
            <div className="flex items-center justify-between w-full flex-none relative self-stretch">
              <div className="relative w-[125.07px] h-[60px]"><img className="relative w-[125.07px] h-[60px]" src="/assets/images/logos/logo-solana-2.svg" /></div>
              <div className="relative w-[125.07px] h-[60px]"><img className="relative w-[125.07px] h-[60px]" src="/assets/images/logos/zksync-seeklogo.svg" /></div>
              <div className="relative w-[125.07px] h-[60px]"><img className="relative w-[125.07px] h-[60px]" src="/assets/images/logos/arbitrum-arb-logo-full.svg" /></div>
              <div className="relative w-[125.07px] h-[60px]"><img className="relative w-[125.07px] h-[60px]" src="/assets/images/logos/idubisfpni-1743412399080-1.svg" /></div>
              <div className="relative w-[125.07px] h-[60px]"><img className="relative w-[125.07px] h-[60px]" src="/assets/images/logos/full-base-logo.svg" /></div>
              <img className="relative w-[125.07px] h-[60px]" src="/assets/images/logos/logo.svg" />
            </div>
          </div>
        </div>
      </div>
